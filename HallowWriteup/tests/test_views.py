...
class TagAPITestCase(APITestCase):
    ...
    def test_update_tag(self):
        ...
        response = self.client.patch(
            f'/api/writeup/tags/{tag_1.slug}/', data, format='json'
        )
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
...
class WebsiteAPITestCase(APITestCase):
    ...
    def test_update_website(self):
        ...
        data = {'name': 'Website X', 'slug': 'website-x'}
        # Unauthorized
        response = self.client.patch(
            f'/api/writeup/websites/{website_1.slug}/', data, format='json'
        )
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
...
class ReportAPITestCase(APITestCase):
    ...
    def test_update_report(self):
        ...
        # Unauthorized
        response = self.client.patch(
            f'/api/writeup/reports/{report_1.slug}/', data, format='json'
        )
        self.assertEqual(response.status_code, status.HTTP_401_UNAUTHORIZED)
