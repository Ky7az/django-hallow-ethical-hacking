...
from HallowWriteup.serializers import ReportSerializer, TagSerializer, WebsiteSerializer
...
class ReportSerializerTestCase(TestCase):
    def test_report(self):
        ...
        expected = {
            ...
            'task_url': 'https://www.task.tld',
            'content': 'Content',
            'create_date': localtime(report.create_date)
            .isoformat()
            .replace('+00:00', 'Z'),
            'write_date': localtime(report.write_date)
            .isoformat()
            .replace('+00:00', 'Z'),
            'active': True,
        }
